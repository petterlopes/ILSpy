...
namespace ILSpy.BamlDecompiler
{
	...
	public class CecilTypeResolver : ITypeResolver
	{
		...
		private AssemblyDefinition thisAssembly;
		...
		private string MakeShort(string name)
		{
		...
		private TypeDefinition TryFindInExportedTypes(string fullName, AssemblyDefinition asm)
		{
